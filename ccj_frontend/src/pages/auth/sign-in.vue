          ...
          <v-card-text>
            <v-form v-model="formValid">
              <v-container height="250" width="350">
                <v-text-field v-model="first" :rules="[rules.required]" color="info" label="Логин"
                  variant="underlined"></v-text-field>
                <v-text-field v-model="last" :rules="[rules.required]" color="info" label="Логин"
                  variant="underlined"></v-text-field>
...
const onSubmit = () => {
  if (formValid.value) {
    console.log('Форма валидна:', { login: first.value, password: password.value })
  }
}
</script>
